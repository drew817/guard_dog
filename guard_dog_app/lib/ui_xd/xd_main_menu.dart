...
import './xd_navigation.dart';

class XDMainMenu extends StatelessWidget {
  XDMainMenu({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child:
                // Adobe XD layer: 'Navigation ' (component)
                XDNavigation(),
          ),
        ],
      ),
