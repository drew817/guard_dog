    ...
    child: XDLogo()
          ...
          Pin(size: 20.0, start: 128.0),
            ...
            hintText: 'Enter First Name',
              hintStyle: TextStyle(fontSize: 7.0, color: Colors.black,height: 2),
            ),
            ),
          ),
          Pinned.fromPins(
          ...
          Pinned.fromPins(
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: TextStyle(fontSize: 7.0, color: Colors.black,height: 0.5),
              ),
            ),
          ),
          Pinned.fromPins(
          ...
          Pinned.fromPins(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: TextStyle(fontSize: 6.5, color: Colors.black,height: 0.5),
              ),
            ),
          ),
          Pinned.fromPins(
